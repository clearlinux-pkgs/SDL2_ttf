...
Source0  : https://www.libsdl.org/projects/SDL_ttf/release/SDL2_ttf-2.24.0.tar.gz
Source1  : https://www.libsdl.org/projects/SDL_ttf/release/SDL2_ttf-2.24.0.tar.gz.sig
...
%setup -q -n SDL2_ttf-2.24.0
cd %{_builddir}/SDL2_ttf-2.24.0
pushd ..
cp -a SDL2_ttf-2.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735841832
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2_ttf-2.0.so.0.2400.0
